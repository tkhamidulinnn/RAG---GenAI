...
Examples:
    ...
    python run_evaluation.py --modes dense hybrid --test-reranking  # Practice 3 features
        """,
    )
    ...
    parser.add_argument(
        ...
        default=["dense"],
        help="Retrieval modes to test (Practice 3)",
    )
    parser.add_argument(
        "--test-reranking",
        action="store_true",
        help="Test with and without re-ranking (Practice 3)",
    )
